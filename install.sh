...
install_sprov-ui() {
    ...
    wget -N --no-check-certificate -O /usr/local/sprov-ui/sprov-ui.jar https://github.com/nescirem/sprov-ui/releases/download/${last_version}/sprov-ui-${last_version}.jar
    if [[ $? -ne 0 ]]; then
    ...
    echo -e "wget -O /usr/bin/sprov-ui -N --no-check-certificate https://github.com/nescirem/sprov-ui/raw/master/sprov-ui.sh && chmod +x /usr/bin/sprov-ui"
    echo -e ""
